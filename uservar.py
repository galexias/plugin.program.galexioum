...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[B][COLOR fff16a15]Galexioum[/COLOR] [COLOR white]Wizard[/COLOR][/B]'
BUILDERNAME = 'Galexioum'
EXCLUDES = [ADDON_ID, 'repository.galexioum']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://dl.dropboxusercontent.com/scl/fi/i4nx1v2ktsk2e33w6kad6/builds.txt?rlkey=0hm9p5gq8b2mdw9zniipzdcey'
...
#           ICONSETTINGS  = 'http://192.168.1.10/public/galexioum/images/settings.png'
# Leave as http:// for default icon
ICONBUILDS = os.path.join(ART, 'builds.png')
ICONMAINT = os.path.join(ART, 'maintenance.png')
ICONSPEED = os.path.join(ART, 'speed.png')
ICONBACKUP = os.path.join(ART, 'backuprestore.png')
...
REPOADDONXML = 'http://192.168.1.10/public/galexioum/plugins/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'http://192.168.1.10/public/galexioum/plugins'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR fff16a15][B]Galexioum[/B][/COLOR]Wizard'
